...
```mermaid
flowchart TD
    D["Penas dulces: menos necesidad de perdón"]
    T["El perdón es la tácita desaprobación de un código absurdo"]
    C["La clemencia es virtud del legislador, no del juez"]:::critico
    I["Perdonar fomenta el halago de la impunidad"]
    V["Y vuelve violencia a las condenas no perdonadas"]
    S["Leyes y jueces inexorables; legislador suave"]
    R["La gravedad de la pena es relativa al estado de la nación"]
    X["Teorema: pública, pronta, necesaria, mínima, proporcionada, legal"]:::critico
    D --> T
    T --> C
    C --> I
    I --> V
