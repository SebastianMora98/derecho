...
```mermaid
flowchart TD
    F["Cuatro falsas ideas de utilidad"]
    F1["Anteponer el inconveniente particular al general"]
    F2["Sacrificar mil ventajas por un mal imaginario"]:::critico
    A["Ejemplo: las leyes que prohíben las armas"]
    R["Desarman al inocente y dan confianza al asaltante"]
    F3["Pedir a los hombres la simetría de la materia inanimada"]
    F4["Dividir el bien público del bien de los particulares"]
    S["El hombre sociable ofende sin beneficio propio"]
    T["El temor público engendra al desesperado y al cuerdo atrevido"]:::critico
    F --> F1
    F --> F2
    F2 --> A
    A --> R
