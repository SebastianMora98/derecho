...
```mermaid
flowchart TD
    I["Interés común: menos delitos en proporción al daño"]
    V["Dos variables: el daño y la tentación"]
    A["No hay exactitud geométrica: cálculo de probabilidad"]
    E["Escala de desórdenes: del que destruye la sociedad a la mínima injusticia"]:::critico
    P["Escala correspondiente de penas, señalando los puntos principales"]
    F["Fuera de esos límites, no hay delito sino interés en nombrarlo"]
    C["Pena igual a delitos desiguales: se comete el mayor"]
    I --> V
    V --> E
    A --> P
    E --> P
