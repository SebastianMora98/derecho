...
```mermaid
flowchart TD
    A["Art. 80: organización de personas y fin no lucrativo"]
    E["Dimensión existencial y axiológica, a la vista en el texto"]
    F["Arts. 77 y 78: la inscripción da la dimensión formal"]
    C["La pluralidad se reduce a un centro ideal e inexistente"]:::critico
    X["El art. 78 dice existencia distinta, sin aclarar que es formal"]
    P["Propuesta: decir formal, y decir que la no responsabilidad es excepcional"]
    A --> E
    F --> C
    C --> X
    X --> P
