...
```mermaid
flowchart TD
    P1["Paso 1: los juristas desconfían de la iusfilosofía"]
    P2["Paso 2: el desdén tiene causa real, ninguna escuela dio cuenta del todo"]
    P3["Paso 3: cada escuela captó solo una parte de la realidad"]
    P4["Paso 4: por eso no sirven para resolver casos concretos"]
    P5["Paso 5: igual se aplica una teoría sin saberlo"]:::critico
    C["Conclusión: parte de la dogmática tradicional está mal fundada"]
    P1 -->|"se explica por"| P2
    P2 -->|"porque"| P3
    P3 -->|"limita al jurista"| P4
    P4 -->|"cierra el círculo del desdén"| P1
    P4 --> P5
    P5 -->|"deriva en"| C
