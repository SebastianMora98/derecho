...
```mermaid
flowchart TD
    R["Tesis romana: es parte del cuerpo de la madre"]
    F["Teoría de la ficción: es una nada jurídica"]
    P["Paradoja: no es cuando es, y cuando es, ya no es"]
    I["Incoherencia: se regulan derechos sin sujeto"]
    C["Código de 1984: la vida empieza con la concepción"]:::critico
    S["Fundamento: la singamia y un código genético único"]
    T["Por eso la condición es resolutoria, no suspensiva"]
    R -->|"descartada"| C
    F --> P
    F --> I
    P --> C
...
1. Que quedan derechos sin sujeto: se regula la representación y se sanciona el aborto de un ente al que se declara inexistente. El autor rastrea la incoherencia hasta Roma, donde se suspendía la ejecución de una condenada gestante (pp. 178-179).
...
3. Que el texto se escribió sin modelo previo y quedó ambiguo justo en el punto decisivo. El autor lo admite: es producto de la creatividad de sus redactores y por eso mejorable. Es honesto, y a la vez debilita al artículo como pieza técnica.
