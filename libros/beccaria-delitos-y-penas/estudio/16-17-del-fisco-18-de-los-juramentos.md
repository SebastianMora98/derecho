...
```mermaid
flowchart TD
    F["Antes: las penas eran pecuniarias y el delito, patrimonio del príncipe"]
    P["El proceso era un pleito entre el fisco y el reo"]
    C["Confesarse reo era confesarse deudor"]
    H["Hoy la causa desapareció pero el efecto sigue: la confesión es el centro"]:::critico
    O["Proceso ofensivo: hay que ser declarado reo para poder probarse inocente"]
    J["El juramento del reo pide jurar contra sí mismo"]
    M["Solo le deja ser mártir o mal cristiano"]
    R["Y degrada la religión hasta volverla formalidad"]
    F --> P
    P --> C
    C --> H
    H --> O
