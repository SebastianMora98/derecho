...
```mermaid
flowchart TD
    C["El contrato social obliga a las dos partes"]
    P1["Primera: solo la ley decreta penas"]
    A["El exceso del juez no es pena, es pena sin ley"]
    P2["Segunda: el soberano legisla pero no juzga"]
    T["Por eso hace falta un tercero: el magistrado"]
    P3["Tercera: una pena inútil ya es injusta"]:::critico
    C --> P1
    P1 --> A
    C --> P2
    P2 --> T
