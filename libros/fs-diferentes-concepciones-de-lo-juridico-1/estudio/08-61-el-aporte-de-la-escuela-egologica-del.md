...
```mermaid
flowchart TD
    K["El formalismo kelseniano dominaba el escenario"]
    E["Cossio funda la escuela egológica en los años cuarenta"]
    R["Raíces: fenomenología de Husserl y filosofía de la existencia"]
    T["Valores y normas se integran DENTRO de la conducta"]:::critico
    O["La conducta intersubjetiva pasa a ser el objeto de estudio"]
    M["Mérito: pone la vida humana en el centro"]
    L["Límite: es una posición reductiva"]
    K -->|"provoca"| E
    R --> E
    E --> T
    T --> O
