...
```mermaid
flowchart TD
    G["La gabela alta crea la utilidad del contrabando"]:::critico
    T["Más tentación, y frontera imposible de custodiar"]
    P["Pena justa: perder el género y la hacienda que lo acompaña"]
    E["Más eficaz cuanto más corta sea la gabela"]
    I["No debe ser infamante: la opinión no lo reprueba"]
    D["Infamar lo indiferente rebaja la infamia de lo grave"]
    S["Si no hay hacienda: prisión o servidumbre"]
    A["Pero análogas al delito: al servicio de la renta defraudada"]:::critico
    G --> T
    T --> P
    P --> E
    I --> D
