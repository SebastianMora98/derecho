...
```mermaid
flowchart TD
    P1["Paso 1: inventario de aportes del código de 1984"]
    P2["Paso 2: dos planos, figuras nuevas y cambios de categoría"]
    P3["Paso 3: lo más valioso no es lo técnico sino el personalismo"]:::critico
    P4["Paso 4: el personalismo es la base de la teoría tridimensional"]
    P5["Paso 5: pronóstico de transición entre dos épocas"]
    R["Reconoce rezagos individualistas en el propio código"]
    P1 --> P2
    P2 -->|"revela una decisión de fondo"| P3
    P3 -->|"se apoya en"| P4
    P3 --> P5
    P5 -->|"pero admite"| R
