...
```mermaid
flowchart TD
    I["Inventario de aportes del código de 1984"]
    D["Dos planos: figuras nuevas y cambios de categoría"]
    P["Lo más valioso no es lo técnico sino el personalismo"]:::critico
    B["El personalismo es la base de la teoría tridimensional"]
    T["Pronóstico: transición entre dos épocas"]
    R["Pero admite rezagos individualistas en el propio código"]
    I --> D
    D -->|"revela una decisión de fondo"| P
    P -->|"se apoya en"| B
    P --> T
    T -->|"con la salvedad"| R
