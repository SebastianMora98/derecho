...
```mermaid
flowchart TD
    D["Distinguir al fallido fraudulento del inocente"]:::critico
    F["Fraudulento: pena del monedero falso"]
    I["Inocente: ninguna privación de libertad, porque es inútil"]
    G["Cuatro grados: dolo, culpa grave, leve, inocencia"]
    L["Los grados los fija la ley, no la prudencia del juez"]
    P["Prevención: registro público de contratos"]
    B["Y un banco que socorra al comerciante infeliz"]:::critico
    D --> F
    D --> I
    D --> G
    G --> L
