...
```mermaid
flowchart TD
    F["La fuerza de la ley viene de la voluntad actual, no de la antigüedad"]
    Q["¿Quién es su legítimo intérprete?"]
    S["El soberano: depositario de las voluntades de todos"]
    J["El juez solo examina si el hecho contraría la ley"]
    SI["Su trabajo es un silogismo perfecto"]:::critico
    E["Consultar el espíritu de la ley abre la incertidumbre"]
    R["Resultado observable: mismo delito, penas distintas"]
    F --> Q
    Q --> S
    Q --> J
    J --> SI
    SI -->|"si hace más de uno"| E
    E --> R
