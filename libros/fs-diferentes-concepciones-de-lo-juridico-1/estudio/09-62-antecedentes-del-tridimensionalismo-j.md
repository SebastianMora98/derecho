...
```mermaid
flowchart TD
    P["Segunda posguerra: aspiración a una comprensión global"]
    G["Etapa genérica y abstracta: los tres elementos, uno al lado del otro"]:::critico
    A["Lask y Radbruch: reconocen la tríada, visión estática"]
    I["Vanni, Del Vecchio, Bobbio: reparto didáctico entre disciplinas"]
    C["Cossio: verifica la tríada pero la reduce a la conducta"]
    S["Sauer y Hall: primeros intentos integradores, con un elemento privilegiado"]
    D["Queda pendiente: cómo se correlacionan los tres"]
    P --> G
    G --> A
    G --> I
    G --> C
