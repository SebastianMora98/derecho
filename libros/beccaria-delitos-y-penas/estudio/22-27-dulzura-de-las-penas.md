...
```mermaid
flowchart TD
    I["El freno es la infalibilidad, no la crueldad"]:::critico
    C["La certeza de un mal pequeño vence al temor de uno grande con esperanza de impunidad"]
    E["Cuanto más atroz, más esfuerzo en eludirla: más delitos para huir de uno"]
    H["Los ánimos se habitúan: la rueda llega a temerse como antes la prisión"]
    F["Basta que el mal de la pena exceda al bien del delito"]:::critico
    S["Lo que pase de ahí es superfluo y tiránico"]
    P1["Consecuencia 1: se pierde la proporción al tocar el límite de la sensibilidad"]
    P2["Consecuencia 2: la impunidad nace de la atrocidad"]
    I --> C
    I --> E
    E --> H
    I --> F
