...
```mermaid
flowchart TD
    D["Distinguir sujeto de derecho de persona"]:::critico
    C["Criterio: ente al que se imputan derechos y deberes"]
    P1["Persona natural"]
    P2["Persona jurídica: organización inscripta"]
    N1["Concebido, o persona por nacer"]
    N2["Organización de personas no inscripta"]
    R["De dos sujetos de derecho se pasa a cuatro"]
    D --> C
    C --> P1
    C --> P2
    C --> N1
