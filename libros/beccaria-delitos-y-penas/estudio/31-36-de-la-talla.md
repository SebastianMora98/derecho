...
```mermaid
flowchart TD
    T["¿Poner precio a la cabeza de un reo?"]
    F["Si está fuera: injuria a otro soberano y delito para el ciudadano"]
    D["Si está dentro: confesión de flaqueza"]
    C["Contradicción: convida a la traición y la castiga"]:::critico
    V["Rompe los vínculos que el legislador estrecha"]
    R["En vez de evitar un delito, hace nacer ciento"]
    N["Recurso de naciones flacas: reparos de un edificio ruinoso"]
    P["Con las luces, buena fe y política se confunden"]:::critico
    T --> F
    T --> D
    F --> C
    D --> C
