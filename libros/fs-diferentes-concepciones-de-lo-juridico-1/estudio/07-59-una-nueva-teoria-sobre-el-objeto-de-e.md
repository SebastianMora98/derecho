...
```mermaid
flowchart TD
    P1["Paso 1: las escuelas unidimensionales fracasaron"]
    P2["Paso 2: la teoría rechaza tomar un solo elemento"]
    P3["Paso 3: los tres interactúan, no se yuxtaponen"]:::critico
    T["Teoría tridimensional del derecho"]
    P4["Paso 4: nace en América Latina, egológica y tridimensionalismo"]
    P5["Paso 5: la justifica un mundo con injusticias reales"]
    C["La persona toma el rol protagónico"]
    P1 -->|"abre paso a"| P2
    P2 -->|"se precisa en"| P3
    P3 -->|"recibe el nombre de"| T
    T --> P4
    T --> P5
    P5 -->|"lleva a"| C
