...
```mermaid
flowchart TD
    O["Ley oscura o en lengua extraña"]
    D["El pueblo queda en dependencia de unos pocos"]
    I["Obliga a interpretar: vuelve el mal del cap. 4"]
    C["Ley clara, escrita y en manos de todos"]:::critico
    E["Sin ley escrita no hay gobierno estable"]
    M["Hace falta un estable monumento del pacto social"]
    P["La imprenta hizo depositario al público"]
    O --> D
    O --> I
    D --> C
    I --> C
