...
```mermaid
flowchart TD
    E["Escuela de la exégesis: lo jurídico está todo en la norma"]
    P["Positivismo: derecho es sinónimo de norma escrita"]
    K["Kelsen: solo el ordenamiento normativo es objeto de estudio"]
    C["Se le concede coherencia y acierto sobre la dimensión formal"]
    L["Pero exilia la vida humana y los valores como impuros"]
    N["Y la norma es pura forma, vacía de contenido"]:::critico
    O["Estudiarla como pensamiento es tarea de la lógica jurídica"]
    E --> P
    P --> K
    K --> C
    C -->|"y aun así"| L
