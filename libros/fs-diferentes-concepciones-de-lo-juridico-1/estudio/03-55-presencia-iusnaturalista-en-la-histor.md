...
```mermaid
flowchart TD
    H["La doctrina se apoyó siglos en el derecho natural"]
    T["Aportes técnicos: privado/público, gobernados/gobernantes"]
    A["Aporte principal: mostró la capacidad valorativa del hombre"]:::critico
    E["El hombre es un ser estimativo: vivencia valores y los inserta en las cosas"]
    V["Los valores son ingredientes del derecho, objetivados en la norma"]
    L["Pero el derecho no se reduce a especular sobre ideales"]
    H --> T
    H --> A
    A --> E
    E --> V
