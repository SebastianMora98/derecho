...
```mermaid
flowchart TD
    G["Estado de guerra: libertad inútil por insegura"]
    S["Cada uno cede una porción mínima de libertad"]
    D["La suma forma la soberanía: un depósito"]:::critico
    U["Hay que defenderlo de las usurpaciones privadas"]
    P["Las penas son los motivos sensibles que lo defienden"]
    N["Todo acto de autoridad sin absoluta necesidad es tiránico"]
    L["La pena es justa en la medida en que deja libertad en pie"]
    G --> S
    S --> D
    D --> U
    U --> P
