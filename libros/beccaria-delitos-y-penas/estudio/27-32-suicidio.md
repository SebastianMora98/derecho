...
```mermaid
flowchart TD
    S["Suicidio: la pena cae sobre inocentes o sobre un insensible"]
    PP["Las penas deben ser meramente personales"]:::critico
    E["Quien emigra daña más: se lleva sus bienes y su persona"]
    L["¿Puede prohibirse salir?"]
    N["No: la ley sería inaplicable, y castigaría la intención"]
    U["Ley inútil envilece a las saludables"]
    B["El modo de retener es aumentar el bienestar relativo"]:::critico
    F["Base: seguridad y libertad limitadas solo por las leyes"]
    S --> PP
    S --> E
    E --> L
    L --> N
