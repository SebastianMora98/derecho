...
```mermaid
flowchart TD
    P1["Paso 1: el derecho no es pura forma lógica"]
    P2["Paso 2: su contenido es vida social, exige interdisciplina"]
    P3["Paso 3: regula buscando valores y el proyecto de vida"]
    T["Paso 4: tres dimensiones en interacción, ninguna suficiente"]:::critico
    P5["Paso 5: cada escuela tomó una sola dimensión"]
    P6["Paso 6: estudiarlas aparte es un problema de conocimiento, no una división real"]
    P7["Paso 7: se entra por cualquiera, pero quedarse en la norma no alcanza"]
    P1 -->|"despeja el terreno para"| T
    P2 -->|"aporta la conducta"| T
    P3 -->|"aporta el valor"| T
    T -->|"explica históricamente"| P5
    P5 -->|"obliga a aclarar"| P6
    P6 -->|"habilita"| P7
