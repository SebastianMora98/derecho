...
```mermaid
flowchart TD
    H["Hurto sin violencia"]
    M["La multa castigaría a la familia y crecería con la miseria"]
    E["Pena: esclavitud por cierto tiempo"]:::critico
    HV["Hurto violento: pena corporal y servil"]
    I["Injuria al honor: pena de infamia"]
    O["Solo funciona si coincide con la infamia de la opinión"]:::critico
    R["Ni frecuente ni colectiva: la infamia de muchos no es infamia"]
    F["Delitos de orgullo: ridiculez, no dolor"]
    H --> M
    M --> E
    H --> HV
    I --> O
