...
```mermaid
flowchart TD
    V["Antes: Constitución de 1933 y Código de 1936, la propiedad en el centro"]
    G["Las dos guerras impulsan la filosofía de la existencia"]
    S["El ser humano es ser libertad, coexistencial y temporal"]:::critico
    L["Sin libertad, no tiene sentido mandar ni prohibir"]
    C["Sin coexistencia, no hay a quién regular"]
    D["Doble papel: proteger al libre y no dañar al otro"]
    P["Ese es el fundamento del Código de 1984"]
    V -->|"se supera con"| P
    G --> S
    S --> L
    S --> C
