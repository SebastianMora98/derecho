...
```mermaid
flowchart TD
    M["Magistrados: interesarlos en la observancia, no en la corrupción"]
    N["Cuerpo numeroso: se vigilan entre sí y ganan menos usurpando"]:::critico
    R["Riesgo: que se tema al magistrado más que a la ley"]
    P["Recompensas: silencio universal de las legislaciones"]
    H["La moneda del honor es inagotable"]
    E["Educación: el medio más seguro y más difícil"]
    C["Guiar a la virtud por el sentimiento"]
    F["Apartar del mal por la necesidad, no por el mando"]:::critico
    M --> N
    M --> R
    P --> H
    E --> C
