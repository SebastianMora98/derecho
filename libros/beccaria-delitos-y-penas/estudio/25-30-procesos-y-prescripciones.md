...
```mermaid
flowchart TD
    T["Tiempo para defenderse, sin perder la prontitud"]
    L["Los plazos los fija la ley: el juez que los fija se hace legislador"]
    P["La probabilidad del delito es inversa a su atrocidad"]:::critico
    A["Delitos atroces: raros"]
    A1["Examen corto: más probable la inocencia"]
    A2["Prescripción larga: el daño de la impunidad es mayor"]
    M["Delitos menores: frecuentes"]
    M1["Examen largo: menos probable la inocencia"]
    M2["Prescripción corta: menor daño de la impunidad"]
    T --> L
    P --> A
    P --> M
    A --> A1
