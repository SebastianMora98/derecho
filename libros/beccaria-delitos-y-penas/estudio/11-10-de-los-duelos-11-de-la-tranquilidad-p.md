...
```mermaid
flowchart TD
    H["El honor quedó fuera del depósito común"]
    D["Duelo: se teme la infamia más que la pena de muerte"]
    R["Remedio: castigar al agresor, absolver al que se defiende"]:::critico
    T["Tranquilidad pública: estrépitos y sermones fanáticos"]
    P["Prevención: alumbrado, guardias, discursos en su lugar"]
    M["El magistrado de Policía"]
    A["Axioma: cada ciudadano debe saber cuándo es reo"]:::critico
    I["La incertidumbre mata más que la crueldad solemne"]
    H --> D
    D --> R
    T --> P
    P --> M
    M -->|"si obra con leyes arbitrarias"| A
    A --> I
