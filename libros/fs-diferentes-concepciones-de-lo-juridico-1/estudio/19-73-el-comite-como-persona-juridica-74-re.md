...
```mermaid
flowchart TD
    C["Art. 111: el comité es persona jurídica si se inscribe"]
    G["Fuente: art. 122 del Código griego de 1944"]
    I["Italia 1942 lo trata como organización NO inscripta"]
    N["Se regula la organización no inscripta, antes irregular o de hecho"]
    U["Única diferencia entre las dos: el registro"]:::critico
    R1["No inscripta: responden los miembros, proporcionalmente"]
    R2["Inscripta: responde un ente ideal"]
    G --> C
    C -->|"contraste"| I
    N --> U
    C --> U
