...
```mermaid
flowchart TD
    V["Los valores son imprescindibles en el derecho"]
    D["Pero no agotan la experiencia jurídica"]:::critico
    S["Hace falta también conducta y norma"]
    F["El iusnaturalismo es insuficiente POR FRAGMENTARIO, no por falso"]
    R["Un sector reaccionó negando los valores"]
    I["Esa reacción es igual de unilateral: vana e infructuosa"]
    C["Criterio: redimensionar, no descartar"]
    V --> D
    D --> S
    S --> F
    F -->|"provocó"| R
