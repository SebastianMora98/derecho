...
```mermaid
flowchart TD
    F["Las escuelas unidimensionales fracasaron"]
    R["Rechaza tomar un solo elemento como objeto"]
    I["Los tres interactúan, no se yuxtaponen"]:::critico
    T["Teoría tridimensional del derecho"]
    L["Nace en América Latina: egológica y tridimensionalismo"]
    M["La justifica un mundo con injusticias reales"]
    P["La persona toma el rol protagónico"]
    F --> R
    R -->|"se precisa en"| I
    I -->|"recibe el nombre de"| T
    T --> L
    T --> M
    M --> P
