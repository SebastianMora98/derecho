...
```mermaid
flowchart TD
    S["Se prohíbe la interrogación sugestiva"]
    T["Y se autoriza la tortura"]
    K["¿Cuál interrogación más sugestiva que el dolor?"]:::critico
    N["Se gobiernan por los nombres, no por las cosas"]
    M["El condenado está civilmente muerto: su deposición es nula"]
    A["Abuso de la gramática: una metáfora contra la verdad"]:::critico
    P["Propuesta: un plazo para producir hechos nuevos"]
    F["Las formalidades son necesarias, pero no contra la verdad"]
    S --> K
    T --> K
    K --> N
    M --> A
