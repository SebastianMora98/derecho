...
```mermaid
flowchart TD
    C["Constitución de 1979, después del proyecto del código"]
    A1["Art. 1: la persona es el fin supremo"]:::critico
    A4["Art. 4: analogía para proteger derechos no positivizados"]
    P["Preámbulo: primacía de la persona, derechos anteriores al Estado"]
    N["Constitución de 1993: el fin supremo es su defensa"]
    D["Diferencia: el fin pasa a ser una actividad, no la persona"]
    C --> A1
    C --> A4
    C --> P
    A1 -->|"contraste"| N
