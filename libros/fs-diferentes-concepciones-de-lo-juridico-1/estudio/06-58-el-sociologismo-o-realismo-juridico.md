...
```mermaid
flowchart TD
    I["Iusnaturalismo y formalismo resultaron insuficientes"]
    R["Aparece el realismo nórdico y el sociologismo estadounidense"]
    D["Toman la dimensión social como objeto de estudio"]
    C["Cierto: no hay derecho fuera de la historia"]
    L["Pero lo social tampoco agota el derecho"]:::critico
    E["La egológica llega a lo mismo por otro camino: la conducta"]
    F["Lo que distingue al derecho es su finalidad: liberar a la persona"]
    I --> R
    R --> D
    D --> C
    C -->|"y aun así"| L
