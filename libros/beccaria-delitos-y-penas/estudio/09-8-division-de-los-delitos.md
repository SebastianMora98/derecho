...
```mermaid
flowchart TD
    D["El daño a la sociedad ordena el catálogo"]
    C1["Primera clase: destruyen la sociedad o a quien la representa"]
    LM["Se llaman de lesa majestad"]
    R["Riesgo: extender el nombre y hacer víctimas de una palabra"]
    C2["Segunda clase: ofenden la seguridad privada"]:::critico
    DP["Dogma político: hacer lo no prohibido sin temer otro daño"]
    G["Incluye los delitos de grandes y magistrados"]
    C3["Tercera clase: contra lo que se debe al bien público"]
    D --> C1
    D --> C2
    D --> C3
    C1 --> LM
