...
```mermaid
flowchart TD
    A["Código de 1936: solo se repara lo valuable en dinero"]
    M["A lo más el daño moral, o pretium doloris"]
    I["El autor ve nacer la figura en Italia entre 1977 y 1983"]
    C["Convence a la Comisión Revisora: un acto de fe"]
    N["Art. 1985: reparación SIN limitación alguna"]:::critico
    O["Los códigos alemán, italiano y portugués sí ponían límites"]
    D["Cubre el proyecto de vida y la estructura psicosomática"]
    A --> M
    I --> C
    C --> N
    O -->|"contraste"| N
