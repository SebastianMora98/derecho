...
```mermaid
flowchart TD
    E["Es mejor evitar los delitos que castigarlos"]:::critico
    Q["Pero no cabe pedir a los hombres un orden geométrico"]
    P["Prohibir acciones indiferentes crea delitos nuevos"]
    M["Por cada motivo de delito real hay mil de acciones indiferentes"]
    T["La mayor parte de las leyes son privilegios"]
    R1["Leyes claras y simples, defendidas por toda la fuerza nacional"]
    R2["Que favorezcan a los hombres, no a las clases"]
    R3["Que se tema a las leyes y a nada más"]:::critico
    E --> Q
    Q --> P
    P --> M
    M --> T
