...
```mermaid
flowchart TD
    M["La medida del delito es el daño hecho a la nación"]:::critico
    I["Error 1: la intención del autor"]
    I2["Varía en cada hombre y momento: haría falta una ley por delito"]
    D["Error 2: la dignidad del ofendido"]
    D2["Absurdo: la irreverencia pesaría más que el regicidio"]
    P["Error 3: la gravedad del pecado"]
    P2["Relaciones con Dios: de dependencia, no de igualdad"]
    P3["La malicia del corazón es impenetrable para seres limitados"]
    I --> I2 --> M
    D --> D2 --> M
    P --> P2 --> M
    P --> P3 --> M
