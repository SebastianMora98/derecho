...
```mermaid
flowchart TD
    P["Los males del saber son inversos a su extensión; los bienes, directos"]:::critico
    C["Comparar objetos contrapone sentimientos y los modera"]
    A["Tiembla la autoridad sin razones; la ley queda inalterable"]
    E1["Primera época dañosa: los errores fundadores se subdividen"]
    E2["Segunda: el paso de los errores a la verdad cuesta una generación"]
    S["Lo peor es el saber mediano y confuso"]
    H["Por eso el hombre iluminado es el mejor guardián de las leyes"]:::critico
    L["Pero hacen falta buenas leyes que multipliquen su número"]
    P --> C
    C --> A
    P --> E1
    E1 --> E2
