...
```mermaid
flowchart TD
    D["Pruebas dependientes: más indicios, menos probabilidad"]
    U["Todas dependen de una: el número no cambia nada"]
    I["Pruebas independientes: más indicios, más probabilidad"]:::critico
    C["La certeza moral es la del buen sentido al obrar"]
    PF["Prueba perfecta: una basta"]
    PI["Prueba imperfecta: hacen falta las que formen una perfecta"]
    J["Juzgar lo que resulta pide buen sentido, no ciencia"]
    G["Jueces iguales, recusación y juicios públicos"]
    D --> C
    U --> C
    I --> C
    C --> PF
