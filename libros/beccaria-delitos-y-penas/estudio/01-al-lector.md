...
```mermaid
flowchart TD
    P1["Paso 1: las leyes vigentes son sedimento histórico, no razón"]
    P2["Paso 2: se anticipa a la acusación de impiedad y sedición"]
    P3["Paso 3: separa revelación, ley natural y pacto social"]:::critico
    P4["Paso 4: aclara los tres errores que no se le deben atribuir"]
    P5["Paso 5: la justicia política es variable; la divina y la natural no"]
    P6["Paso 6: reparte competencias entre teólogo y publicista"]
    P7["Paso 7: solo vale la crítica lógica o política, no la de impiedad"]
    P1 -->|"justifica examinar el sistema penal"| P2
    P2 -->|"obliga a distinguir planos"| P3
    P3 -->|"permite precisar"| P4
    P3 -->|"fundamenta"| P5
    P5 -->|"se traduce en"| P6
    P4 --> P7
    P6 --> P7
