...
```mermaid
flowchart TD
    B["Las leyes vigentes son sedimento histórico, no razón"]
    A["Se anticipa a la acusación de impiedad y sedición"]
    S["Separa revelación, ley natural y pacto social"]:::critico
    V["La justicia política es variable; la divina y la natural no"]
    O["Reparte oficios: teólogo y publicista"]
    C["Solo vale la crítica lógica o política"]
    B -->|"justifica examinar el sistema penal"| A
    A -->|"obliga a distinguir planos"| S
    S --> V
    V -->|"se traduce en"| O
    O --> C
