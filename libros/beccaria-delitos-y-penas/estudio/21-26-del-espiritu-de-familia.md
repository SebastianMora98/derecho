...
```mermaid
flowchart TD
    F["Sociedad concebida como unión de familias"]
    N["20.000 hombres y 80.000 esclavos"]:::critico
    M["Una república hecha de pequeñas monarquías"]
    L["El espíritu monárquico pasa a las leyes"]
    H["Sociedad concebida como unión de hombres"]
    C["La familia es subordinación de contrato, no de mando"]
    R["El espíritu republicano llega a las paredes domésticas"]
    D["Doble moral: temor en casa, libertad en la plaza"]
    F --> N
    N --> M
    M --> L
    L --> D
