...
```mermaid
flowchart TD
    P["Las leyes son la suma de mínimas porciones de libertad"]
    V["Nadie cedió su vida: no está en el depósito"]:::critico
    G["Luego no es derecho: es guerra de la nación contra un ciudadano"]
    N1["¿Necesaria por el poder del reo? Solo en la anarquía"]
    N2["¿Necesaria como freno? No: importa la extensión, no la intensidad"]:::critico
    E["La esclavitud perpetua da muchos ejemplos durables por un solo delito"]
    A["Y atemoriza más a quien la ve que a quien la sufre"]
    M["Mal ejemplo: la ley que detesta el homicidio ordena un asesinato público"]
    P --> V
    V --> G
    G --> N1
    G --> N2
