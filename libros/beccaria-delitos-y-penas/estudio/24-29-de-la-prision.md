...
```mermaid
flowchart TD
    A["La prisión precede a la declaración del delito"]
    L["Pero solo la ley puede fijar los indicios que la autorizan"]:::critico
    C["Cárcel más humana permite exigir indicios menores"]
    I["El absuelto no debería retener nota de infamia"]
    J["Jurisdicción: el lugar de la pena es el lugar del delito"]:::critico
    V["Los jueces vengan pactos, no la malicia de las acciones"]
    P["El perdón del ofendido no borra la pena"]
    D["Porque el derecho de castigar es de todos los ciudadanos"]
    A --> L
    L --> C
    L --> I
    J --> V
