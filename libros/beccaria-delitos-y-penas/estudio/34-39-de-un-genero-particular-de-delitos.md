...
```mermaid
flowchart TD
    O["Un género de delitos que cubrió Europa de sangre"]
    D["Descripción cruda de las hogueras"]
    C["El lugar, el siglo y la materia no permiten examinarlo"]:::critico
    T1["Sería largo probar la necesidad de uniformidad de pensamiento"]
    T2["Hay opiniones que se aclaran con el choque"]
    T3["Y otras que deben vestirse de autoridad y fuerza"]
    A["Todo eso, si hay quien con reconocida autoridad lo ejercite"]
    L["El libro trata delitos, no pecados"]:::critico
    O --> D
    D --> C
    C --> T1
    C --> T2
