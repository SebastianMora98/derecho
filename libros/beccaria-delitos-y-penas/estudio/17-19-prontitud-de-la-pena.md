...
```mermaid
flowchart TD
    J["Más justa: evita la incertidumbre y acorta la prisión previa"]
    K["La cárcel es solo custodia: mínima en tiempo y en dureza"]
    U["Más útil: asocia en la mente delito y pena"]:::critico
    A["La unión de ideas es el cemento del entendimiento"]
    V["Los entendimientos vulgares solo captan asociaciones inmediatas"]
    R["Si se dilata, la pena se vuelve espectáculo y no castigo"]
    N["Segundo principio: pena análoga a la naturaleza del delito"]
    J --> K
    U --> A
    A --> V
    U --> R
