...
```mermaid
flowchart TD
    P1["Paso 1: la gente recibe las leyes por tradición y no las examina"]
    P2["Paso 2: las leyes debían ser pactos y fueron urgencias de pocos"]:::critico
    P3["Paso 3: criterio, la mayor felicidad en el mayor número"]
    P4["Paso 4: lo penal quedó sin examinar en casi toda Europa"]
    P5["Paso 5: sigue a Montesquieu pero reclama sus propios pasos"]
    C["Legitima examinar el sistema penal"]
    P1 -->|"explica que el abuso durara siglos"| P2
    P2 -->|"exige una vara de medida"| P3
    P2 --> P4
    P3 --> P4
    P4 --> P5
    P5 --> C
